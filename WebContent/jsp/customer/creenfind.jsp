...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/customer_screenFind.action"
		method=post>
									...
									<TD>
										<TABLE id=grid
											...
											<%-- 	<c:forEach items="${list }" var="customer">
												...
												<!-- struts 标签 -->
												 <s:iterator value="screenFind" var="cus">
												 ...
												 <TR
													...
													<TD>
	                                                  <a href="${pageContext.request.contextPath }/customer_deleteCus.action?cid=${cus.cid}">删除</a>
													   <a href="${pageContext.request.contextPath }/customer_showCus.action?cid=${cus.cid}">修改</a>
													</TD>
												</TR>
												 </s:iterator>
